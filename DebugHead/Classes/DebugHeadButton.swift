...
open class DebugHeadButton: UIWindow {
  open static let shared = DebugHeadButton.instance()
...
//    bugLineWidth = 1
  ...
  private static func instance() -> DebugHeadButton {
    return DebugHeadButton()
  }
  
  private static var bundle: Bundle {
    return Bundle(path: Bundle(for: DebugHeadButton.self).path(forResource: "DebugHeadButton", ofType: "bundle")!)!
  }
...
//  }
  ...
  private func openDebugMenu() {
    let nc = UIStoryboard(name: "DebugMenu", bundle: DebugHeadButton.bundle).instantiateInitialViewController() as! UINavigationController
